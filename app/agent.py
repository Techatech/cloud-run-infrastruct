...
class InfrastructurePlan(BaseModel):
    ...
    diagram_code: str = Field(
        default="", 
        description="The final ascii text diagram code for the architecture diagram."
    )
    cost_estimate: str = Field(
        default="", 
        description="The cost estimation to run the plan."
    )
    iac_code: str = Field(
        default="", 
...
DiagrammerAgent = LlmAgent(
    ...
    instruction=(
        ...
        "Return the text diagram generated by the tool."
    ),
